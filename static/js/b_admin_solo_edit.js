$(function () {
    $('#default_register').click(function (e) {
        e.preventDefault()
        $.ajax({
            url: '/re/b/admin/solo/edit/default/register/',
            type: 'post',
            dataType: 'json',
            cache: false,
            data: {
    ...
    $('#photo_main_register').click(function (e) {
        e.preventDefault()
        $.ajax({
            url: '/re/b/admin/solo/edit/main/photo/register/',
            type: 'post',
            dataType: 'json',
            cache: false,
            data: {
    ...
    $('#photo_delete').click(function (e) {
        e.preventDefault()
        $.ajax({
            url: '/re/b/admin/solo/edit/photo/delete/',
            type: 'post',
            dataType: 'json',
            cache: false,
            data: {
    ...
    $('#name_delete').click(function (e) {
        e.preventDefault()
        $.ajax({
            url: '/re/b/admin/solo/edit/name/delete/',
            type: 'post',
            dataType: 'json',
            cache: false,
            data: {
    ...
    $('#name_register').click(function (e) {
        e.preventDefault()
        $.ajax({
            url: '/re/b/admin/solo/edit/name/register/',
            type: 'post',
            dataType: 'json',
            cache: false,
            data: {
    ...
    $('#main_name_register').click(function (e) {
        e.preventDefault()
        $.ajax({
            url: '/re/b/admin/solo/edit/main/name/',
            type: 'post',
            dataType: 'json',
            cache: false,
            data: {
    ...
    $(".js-crop-and-upload").click(function () {
        ...
        $.ajax({
            url: '/re/b/admin/solo/upload/photo/',
            type: 'post',
            dataType: 'json',
            cache: false,
            processData: false,
