"""
Django settings for implin project.
...
SETTINGS_DIR = os.path.join(BASE_DIR, 'implin')
...
if settings_json['debug']['boolean'] == 'true':
    ...
    WSGI_APPLICATION = 'implin.wsgi.application'
    ...
    pass
elif settings_json['debug']['boolean'] == 'true_b':
    pass
elif settings_json['debug']['boolean'] == 'false'
    pass